  ...
  computed: {
    main() {
      return (
        ...
        this.$route.path !== "/regist_user_detail"
      );
    },
    print() {
      return (
        this.$route.path !== "/print/employees" &&
        this.$route.path !== "/print/products" &&
        this.$route.path !== "/print/items" &&
        this.$route.path !== "/print/powers" &&
        this.$route.path !== "/print/address"
      );
    },
  },
  mounted() {

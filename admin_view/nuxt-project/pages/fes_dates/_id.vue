  ...
  <div>
    ...
    <div v-else>
              ...
              <ul>
                <li>
                  <div class="breadcrumbs-item">
                    <router-link to="/fes_dates">開催日一覧</router-link>
                  </div>
                </li>
                <li>
                  <div class="breadcrumbs-item">
                  ...
                  <template v-slot:default>
                    <tbody>
                      ...
                      <tr>
                        <th>登録日時：</th>
                        <td class="caption">
                          {{ fes_date.fes_date.created_at | formatDate }}
                        </td>
                      </tr>
                      <tr>
                        <th>編集日時：</th>
                        <td class="caption">
                          {{ fes_date.fes_date.updated_at | formatDate }}
                        </td>
                      </tr>
                    </tbody>
                  </template>
      ...
      <v-row>
        <v-col>
          <div class="card">
            <v-btn text color="white" to="/fes_dates"
              ><v-icon color="#333333">mdi-arrow-left-bold</v-icon>
              <div class="back-button">開催日一覧に戻る</div></v-btn
            >
          </div>
        </v-col>
      </v-row>

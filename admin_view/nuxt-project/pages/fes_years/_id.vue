  ...
  <div>
    ...
    <div v-else>
              ...
              <ul>
                <li>
                  <div class="breadcrumbs-item">
                    <router-link to="/fes_years">開催年一覧</router-link>
                  </div>
                </li>
                <li>
                  <div class="breadcrumbs-item">{{ fes_year.year_num }}</div>
                </li>
              </ul>
            </div>
          </v-card-text>
                  ...
                  <template v-slot:default>
                    <tbody>
                      ...
                      <tr>
                        <th>登録日時：</th>
                        <td class="caption">
                          {{ fes_year.created_at | formatDate }}
                        </td>
                      </tr>
                      <tr>
                        <th>編集日時：</th>
                        <td class="caption">
                          {{ fes_year.updated_at | formatDate }}
                        </td>
                      </tr>
                    </tbody>
                  </template>
      ...
      <v-row>
        <v-col>
          <div class="card">
            <v-btn text color="white" to="/fes_years"
              ><v-icon color="#333333">mdi-arrow-left-bold</v-icon>
              <div class="back-button">開催年一覧に戻る</div></v-btn
            >
          </div>
        </v-col>
      </v-row>

<template>
  <div>
    <v-row>
      <v-col cols="1"></v-col>
      <v-col cols="10">
        <v-card-text><router-link to="/food_products">販売食品一覧</router-link>>{{ food_product.group_id }}</v-card-text>
      </v-col>
    </v-row>
              ...
              <v-simple-table class="my-9">
                <template v-slot:default>
                  <tbody>
                    ...
                    <tr>
                      <th>名前：</th>
                      <td class="caption">{{ food_product.name }}</td>
                    </tr>
                    <tr>
                      <th>１日目の個数：</th>
                    ...
                    <tr>
                      <th>調理の有無：</th>
                      <td class="caption">{{ food_product.is_cooking }}</td>
                    </tr>
                    <tr>
                      <th>登録日時：</th>

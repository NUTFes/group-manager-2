                ...
                <v-simple-table class="my-9">
                  <template v-slot:default>
                    <tbody>
                      ...
                      <tr>
                        <th>調理の有無：</th>
                        <td v-if="food_product.is_cooking == true" class="caption" ><v-chip  color="red" text-color="white" small>する</v-chip></td>
                        <td v-if="food_product.is_cooking == false" class="caption" ><v-chip  color="blue" text-color="white" small>しない</v-chip></td>
                      </tr>
                      <tr>
                        <th>登録日時：</th>
...
export default {
  ...
  methods: {
    ...
    edit: function() {
      const edit_url = '/food_products/' + this.id + '?group_id=' + this.group_id + '&name=' + this.name + '&first_day_num=' + this.first_day_num + '&second_day_num=' + this.second_day_num + '&is_cooking=' + this.is_cooking

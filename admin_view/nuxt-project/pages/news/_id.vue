  ...
  <div>
    ...
    <div v-else>
              ...
              <ul>
                <li>
                  <div class="breadcrumbs-item">
                    <router-link to="/news">お知らせ一覧</router-link>
                  </div>
                </li>
                <li>
                  <div class="breadcrumbs-item">{{ news.title }}</div>
                </li>
              </ul>
            </div>
          </v-card-text>
      ...
      <v-row>
        <v-col>
          <div class="card">
            <v-btn text color="white" to="/news"
              ><v-icon color="#333333">mdi-arrow-left-bold</v-icon>
              <div class="back-button">お知らせ一覧に戻る</div></v-btn
            >
          </div>
        </v-col>
      </v-row>

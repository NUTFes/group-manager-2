      ...
      <table border="solid">
        ...
        <tbody v-for="group in group_1" :key="group.group.id">
          <tr>
            ...
            <td v-if="group.assign_rental_item.length !== 0">
              {{ group.assign_rental_item[0].name }}
            </td>
            <td v-else-if="group.assign_rental_item.length === 0">未登録</td>
            <td v-if="group.assign_rental_item.length !== 0">
              {{ group.assign_rental_item[0].place }}
            </td>
            <td v-else-if="group.assign_rental_item.length === 0">未登録</td>
            <td v-if="group.assign_rental_item.length !== 0">
              {{ group.assign_rental_item[0].num }}
            </td>
            <td v-else-if="group.assign_rental_item.length === 0">未登録</td>
          </tr>
          <tr
            v-for="i in group.assign_rental_item.slice(1)"
            v-if="group.assign_rental_item.slice(1) !== 0"
          >
            <td>{{ i.name }}</td>
            <td>{{ i.place }}</td>
            <td>{{ i.num }}</td>

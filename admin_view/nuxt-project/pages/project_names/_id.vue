<template>
  <div>
            ...
            <ul>
              <li>
                <div class="breadcrumbs-item">
                  <router-link to="/project_names">企画名一覧</router-link>
                </div>
              </li>
              <li>
                <div class="breadcrumbs-item">{{ group.project_name }}</div>
              </li>
            </ul>
          </div>
        </v-card-text>
    ...
    <v-row>
      <v-col cols="1o">
        <div class="card">
          <v-btn text color="white" to="/project_names"
            ><v-icon color="#333333">mdi-arrow-left-bold</v-icon>
            <div class="back-button">企画名一覧に戻る</div></v-btn
          >
        </div>
      </v-col>
    </v-row>

<template>
                ...
                <v-simple-table class="my-9">
                  <template v-slot:default>
                    <tbody>
                      ...
                      <tr>
                        <th>登録日時：</th>
                        <td class="caption">{{ shop.created_at | format-date }}</td>
                      </tr>
                      <tr>
                        <th>編集日時：</th>
                        <td class="caption">{{ shop.updated_at | format-date }}</td>
                      </tr>
                    </tbody>
                  </template>
                </v-simple-table>
  ...
  export default {
    ...
    edit: function() {
      const edit_url = '/shops/' + this.id + '?name=' + this.name + '&tel=' + this.tel +'&opening_hours=' + this.opening_hours +'&address=' + this.address

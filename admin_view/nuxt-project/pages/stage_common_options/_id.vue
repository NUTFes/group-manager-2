...
export default {
  ...
  mounted() {
    ...
    this.$axios.get(url, {
      ...
      .then(response => {
        ...
        this.camera_permission = response.data.stage_common_option.camera_permission
  ...
  methods: {
    ...
    edit: function() {
      const edit_url = '/stage_common_options/' + this.id + '?group_id=' + this.group_id + '&own_equipment=' + this.own_equipment + '&bgm=' + this.bgm + '&camera_permission=' + this.camera_permission + '&loud_sound=' + this.loud_sound +'&stage_content=' + this.stage_content 

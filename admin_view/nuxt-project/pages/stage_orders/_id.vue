      ...
      <v-card>
        <v-card-title class="headline blue-grey darken-3">
          <div style="color: white">
            <v-icon class="ma-5" dark>mdi-pencil</v-icon
            >編集
          </div>
          <v-spacer></v-spacer>
...
export default {
  ...
  methods: {
    ...
    edit: function() {
      const edit_url = '/stage_orders/' + this.stage_order.id + '?group_id=' + this.group_id + '&is_sunny=' + this.is_sunny + '&fes_date_id=' + this.fes_date_id + '&stage_first_id=' + this.stage_first_id + '&stage_second=' + this.stage_second_id + '&use_time_interval=' + this.use_time_interval + '&prepare_time_interval=' + this.prepare_time_interval + '&cleanup_time_interval=' + this.cleanup_time_interval + '&prepare_start_time=' + this.prepareStartTime + '&performance_start_time=' + this.performanceStartTime + '&performance_end_time=' + this.performanceEndTime + '&cleanup_end_time=' + this.cleanupEndTime

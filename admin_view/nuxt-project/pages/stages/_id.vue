      ...
      <v-col>
        ...
        <v-card-text>
          <div class="breadcrumbs">
            <ul>
              <li><div class="breadcrumbs-item"><router-link to="/stages">ステージ一覧</router-link></div></li>
              <li><div class="breadcrumbs-item">{{ stage.name }}</div></li>
            </ul>
          </div>
        </v-card-text>
        </div>
                ...
                <template v-slot:default>
                  <tbody>
                    ...
                    <tr>
                      <th>晴れ：</th>
                      <td>
                    <v-chip v-if="stage.enable_sunny == true" color="red" text-color="white" small>使用可能</v-chip>
                    <v-chip v-if="stage.enable_sunny == false" color="blue" text-color="white" small>使用不可能</v-chip>
                      </td>
                    </tr>
                    <tr>
                      <th>雨：</th>
                      <td>
                    <v-chip v-if="stage.enable_rainy == true" color="red" text-color="white" small>使用可能</v-chip>
                    <v-chip v-if="stage.enable_rainy == false" color="blue" text-color="white" small>使用不可能</v-chip>
                      </td>
                    </tr>
                    <tr>
                      <th>登録日時：</th>
                      <td class="caption">{{ stage.created_at | format-date }}</td>
                    </tr>
                    <tr>
                      <th>編集日時：</th>
                      <td class="caption">{{ stage.updated_at | format-date }}</td>
                    </tr>
                  </tbody>
                </template>
              </v-simple-table>

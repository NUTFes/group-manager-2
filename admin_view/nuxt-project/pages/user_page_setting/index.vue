      ...
      <v-card flat class="mx-15">
        ...
        <v-row>
          ...
          <v-col cols="2">
            ...
            <v-card-text v-if="is_edit_group === false"
              >募集締め切り</v-card-text
            >
          </v-col>
          <v-col cols="2">
        ...
        <v-row>
          ...
          <v-col cols="2">
            ...
            <v-card-text v-if="is_edit_place === false"
              >募集締め切り</v-card-text
            >
          </v-col>
          <v-col cols="2">
        ...
        <v-row>
          ...
          <v-col cols="2">
            <v-card-text v-if="is_edit_power_order === true"
              >募集中</v-card-text
            >
        ...
        <v-row>
          ...
          <v-col cols="2">
            <v-card-text v-if="is_edit_rental_order === true"
              >募集中</v-card-text
            >
        ...
        <v-row>
          ...
          <v-col cols="2">
            <v-card-text v-if="is_edit_stage_order === true"
              >募集中</v-card-text
            >
        ...
        <v-row>
          ...
          <v-col cols="2">
            ...
            <v-card-text v-if="add_employee === false"
              >募集締め切り</v-card-text
            >
          </v-col>
          <v-col cols="2">
        ...
        <v-row>
          ...
          <v-col cols="2">
            <v-card-text v-if="is_edit_food_product === true"
              >募集中</v-card-text
            >

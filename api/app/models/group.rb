class Group < ApplicationRecord
  ...
  # 割り当てられたステージを取得
  def stage
    group_identification.nil? || group_identification.stage_number.nil? ? nil : group_identification.stage_number.stage.name
  end

  # 割り当てられた会場を取得
  def place
    group_identification.nil? || group_identification.place_number.nil? ? nil : group_identification.place_number.place.name
  end

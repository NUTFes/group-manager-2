...
Rails.application.routes.draw do
  ...
  resources :fire_equipment_orders, except: [:destroy] do
    collection do
      ...
      delete 'user/:id', to: 'fire_equipment_orders#user_destroy'
    end
  end
  ...
  namespace 'api' do
    namespace 'v1' do
      #---管理者画面用---
      resources :power_orders, only: %i[update destroy]
      resources :fire_equipment_orders, only: %i[update destroy]

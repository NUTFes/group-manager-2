...
rental_items = [
  ...
  { id: 2, name: '長机', name_en: 'Long Desk', is_inside_shop_rentable: false, is_outside_shop_rentable: true, is_stage_rentable: true },
  ...
  { id: 21, name: '暗幕(350*305)', name_en: 'Blackout Curtain (350x305)', is_inside_shop_rentable: false, is_outside_shop_rentable: true, is_stage_rentable: false },
  ...
  { id: 23, name: '暗幕(240*200)', name_en: 'Blackout Curtain (240x200)', is_inside_shop_rentable: false, is_outside_shop_rentable: true, is_stage_rentable: false },
...
RentalItem.seed(:id, *rental_items)

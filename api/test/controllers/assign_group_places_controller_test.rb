...
class AssignGroupPlacesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create assign_group_place' do
    assert_difference('AssignGroupPlace.count') do
      post assign_group_places_url, params: { assign_group_place: { stocker_place_id: @assign_group_place.stocker_place_id, place_order_id: @assign_group_place.place_order_id } }, as: :json
    end
  ...
  test 'should update assign_group_place' do
    patch assign_group_place_url(@assign_group_place), params: { assign_group_place: { stocker_place_id: @assign_group_place.stocker_place_id, place_order_id: @assign_group_place.place_order_id } }, as: :json
    assert_response :ok
  end

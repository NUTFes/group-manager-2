...
class SubRepsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create sub_rep' do
    assert_difference('SubRep.count') do
      post sub_reps_url,
           params: { sub_rep: { department_id: @sub_rep.department_id, email: @sub_rep.email, grade_id: @sub_rep.grade_id, group_id: @sub_rep.group_id, name: @sub_rep.name, tel: @sub_rep.tel } }, as: :json
    end

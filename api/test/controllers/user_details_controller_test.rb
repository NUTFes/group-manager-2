...
class UserDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create user_detail' do
    assert_difference('UserDetail.count') do
      post user_details_url, params: { department_id: @user_detail.department_id, grade_id: @user_detail.grade_id, tel: @user_detail.tel, user_id: @user_detail.user_id, student_id: @user_detail.student_id }, as: :json
    end
  ...
  test 'should update user_detail' do
    patch user_detail_url(@user_detail), params: { department_id: @user_detail.department_id, grade_id: @user_detail.grade_id, tel: @user_detail.tel, user_id: @user_detail.user_id, student_id: @user_detail.student_id }, as: :json
    assert_response :ok
  end

...
const Status = ({ statusType, status })=>{
    ...
    if (statusInfo.statusType !== statusType) {
        console.warn(`statusType="${statusType}" と status="${status}"の組み合わせは不適切です!!`);
    }
...
//# sourceMappingURL=components-Status-Status-stories.a295e94e06e6f7844e31.hot-update.js.map
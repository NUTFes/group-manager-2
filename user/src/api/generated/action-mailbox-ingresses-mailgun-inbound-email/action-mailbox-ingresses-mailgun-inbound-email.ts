...
import type {
  ...
  ActionmailboxIngressesMailgunInboundEmailBody
} from '../schemas';
 ...
 */
export const postRailsActionMailboxMailgunInboundEmailsMime = async (actionmailboxIngressesMailgunInboundEmailBody?: ActionmailboxIngressesMailgunInboundEmailBody, options?: RequestInit): Promise<postRailsActionMailboxMailgunInboundEmailsMimeResponse> => {
  ...
  return openApiFetch<postRailsActionMailboxMailgunInboundEmailsMimeResponse>(getPostRailsActionMailboxMailgunInboundEmailsMimeUrl(),
  {
    ...
    body: JSON.stringify(actionmailboxIngressesMailgunInboundEmailBody)
  }
);}
...
export const getPostRailsActionMailboxMailgunInboundEmailsMimeMutationFetcher = ( options?: SecondParameter<typeof openApiFetch>) => {
  return (_: Key, { arg }: { arg: ActionmailboxIngressesMailgunInboundEmailBody | undefined }) => {
...
export const usePostRailsActionMailboxMailgunInboundEmailsMime = <TError = ActionmailboxIngressesMailgunInboundEmail>(
   options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof postRailsActionMailboxMailgunInboundEmailsMime>>, TError, Key, ActionmailboxIngressesMailgunInboundEmailBody | undefined, Awaited<ReturnType<typeof postRailsActionMailboxMailgunInboundEmailsMime>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {

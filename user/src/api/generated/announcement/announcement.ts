 ...
 */
export const postAnnouncements = async (announcementBody?: AnnouncementBody, options?: RequestInit): Promise<postAnnouncementsResponse> => {
...
export const getPostAnnouncementsMutationFetcher = ( options?: SecondParameter<typeof openApiFetch>) => {
  return (_: Key, { arg }: { arg: AnnouncementBody | undefined }) => {
...
export const usePostAnnouncements = <TError = Announcement>(
   options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof postAnnouncements>>, TError, Key, AnnouncementBody | undefined, Awaited<ReturnType<typeof postAnnouncements>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {
...
export const patchAnnouncementsId = async (id: number,
    announcementBody?: AnnouncementBody, options?: RequestInit): Promise<patchAnnouncementsIdResponse> => {
...
export const usePatchAnnouncementsId = <TError = void | Announcement>(
  id: number, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof patchAnnouncementsId>>, TError, Key, AnnouncementBody | undefined, Awaited<ReturnType<typeof patchAnnouncementsId>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {
...
export const putAnnouncementsId = async (id: number,
    announcementBody?: AnnouncementBody, options?: RequestInit): Promise<putAnnouncementsIdResponse> => {
...
export const usePutAnnouncementsId = <TError = void | Announcement>(
  id: number, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof putAnnouncementsId>>, TError, Key, AnnouncementBody | undefined, Awaited<ReturnType<typeof putAnnouncementsId>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {

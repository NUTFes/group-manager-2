 ...
 */
export const postApiV1GetRefinementEmployees = async (apiV1EmployeesApiBody?: ApiV1EmployeesApiBody, options?: RequestInit): Promise<postApiV1GetRefinementEmployeesResponse> => {
  ...
  return openApiFetch<postApiV1GetRefinementEmployeesResponse>(getPostApiV1GetRefinementEmployeesUrl(),
  {
    ...
    body: JSON.stringify(apiV1EmployeesApiBody)
  }
);}
...
export const getPostApiV1GetRefinementEmployeesMutationFetcher = ( options?: SecondParameter<typeof openApiFetch>) => {
  return (_: Key, { arg }: { arg: ApiV1EmployeesApiBody | undefined }) => {
...
export const usePostApiV1GetRefinementEmployees = <TError = ApiV1EmployeesApi>(
   options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof postApiV1GetRefinementEmployees>>, TError, Key, ApiV1EmployeesApiBody | undefined, Awaited<ReturnType<typeof postApiV1GetRefinementEmployees>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {
 ...
 * @summary post summary
 */
export const postApiV1GetSearchEmployees = async (apiV1EmployeesApiBody?: ApiV1EmployeesApiBody, options?: RequestInit): Promise<postApiV1GetSearchEmployeesResponse> => {
...
export const usePostApiV1GetSearchEmployees = <TError = ApiV1EmployeesApi>(
   options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof postApiV1GetSearchEmployees>>, TError, Key, ApiV1EmployeesApiBody | undefined, Awaited<ReturnType<typeof postApiV1GetSearchEmployees>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {

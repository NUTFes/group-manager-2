...
import type {
  ...
  ApiV1HealthCenterSubmissionStatusesApiBody
} from '../schemas';
 ...
 */
export const postApiV1CreateHealthCenterSubmissionStatusComment = async (apiV1HealthCenterSubmissionStatusesApiBody?: ApiV1HealthCenterSubmissionStatusesApiBody, options?: RequestInit): Promise<postApiV1CreateHealthCenterSubmissionStatusCommentResponse> => {
  ...
  return openApiFetch<postApiV1CreateHealthCenterSubmissionStatusCommentResponse>(getPostApiV1CreateHealthCenterSubmissionStatusCommentUrl(),
  {
    ...
    body: JSON.stringify(apiV1HealthCenterSubmissionStatusesApiBody)
  }
);}
...
export const getPostApiV1CreateHealthCenterSubmissionStatusCommentMutationFetcher = ( options?: SecondParameter<typeof openApiFetch>) => {
  return (_: Key, { arg }: { arg: ApiV1HealthCenterSubmissionStatusesApiBody | undefined }) => {
...
export const patchApiV1UpdateHealthCenterSubmissionStatusId = async (id: number,
    apiV1HealthCenterSubmissionStatusesApiBody?: ApiV1HealthCenterSubmissionStatusesApiBody, options?: RequestInit): Promise<patchApiV1UpdateHealthCenterSubmissionStatusIdResponse> => {
...
export const usePatchApiV1UpdateHealthCenterSubmissionStatusId = <TError = void | ApiV1HealthCenterSubmissionStatusesApi>(
  id: number, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof patchApiV1UpdateHealthCenterSubmissionStatusId>>, TError, Key, ApiV1HealthCenterSubmissionStatusesApiBody | undefined, Awaited<ReturnType<typeof patchApiV1UpdateHealthCenterSubmissionStatusId>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {

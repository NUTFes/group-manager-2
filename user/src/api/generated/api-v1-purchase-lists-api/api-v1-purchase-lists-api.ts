 ...
 */
export const postApiV1GetRefinementPurchaseLists = async (apiV1PurchaseListsApiBody?: ApiV1PurchaseListsApiBody, options?: RequestInit): Promise<postApiV1GetRefinementPurchaseListsResponse> => {
  ...
  return openApiFetch<postApiV1GetRefinementPurchaseListsResponse>(getPostApiV1GetRefinementPurchaseListsUrl(),
  {
    ...
    body: JSON.stringify(apiV1PurchaseListsApiBody)
  }
);}
...
export const getPostApiV1GetRefinementPurchaseListsMutationFetcher = ( options?: SecondParameter<typeof openApiFetch>) => {
  return (_: Key, { arg }: { arg: ApiV1PurchaseListsApiBody | undefined }) => {
...
export const usePostApiV1GetRefinementPurchaseLists = <TError = ApiV1PurchaseListsApi>(
   options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof postApiV1GetRefinementPurchaseLists>>, TError, Key, ApiV1PurchaseListsApiBody | undefined, Awaited<ReturnType<typeof postApiV1GetRefinementPurchaseLists>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {
 ...
 * @summary post summary
 */
export const postApiV1GetSearchPurchaseLists = async (apiV1PurchaseListsApiBody?: ApiV1PurchaseListsApiBody, options?: RequestInit): Promise<postApiV1GetSearchPurchaseListsResponse> => {
...
export const usePostApiV1GetSearchPurchaseLists = <TError = ApiV1PurchaseListsApi>(
   options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof postApiV1GetSearchPurchaseLists>>, TError, Key, ApiV1PurchaseListsApiBody | undefined, Awaited<ReturnType<typeof postApiV1GetSearchPurchaseLists>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {

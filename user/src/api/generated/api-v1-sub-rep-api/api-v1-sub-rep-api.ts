 ...
 */
export const postApiV1GetSearchSubReps = async (apiV1SubRepApiBody?: ApiV1SubRepApiBody, options?: RequestInit): Promise<postApiV1GetSearchSubRepsResponse> => {
  ...
  return openApiFetch<postApiV1GetSearchSubRepsResponse>(getPostApiV1GetSearchSubRepsUrl(),
  {
    ...
    body: JSON.stringify(apiV1SubRepApiBody)
  }
);}
...
export const getPostApiV1GetSearchSubRepsMutationFetcher = ( options?: SecondParameter<typeof openApiFetch>) => {
  return (_: Key, { arg }: { arg: ApiV1SubRepApiBody | undefined }) => {
...
export const usePostApiV1GetSearchSubReps = <TError = ApiV1SubRepApi>(
   options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof postApiV1GetSearchSubReps>>, TError, Key, ApiV1SubRepApiBody | undefined, Awaited<ReturnType<typeof postApiV1GetSearchSubReps>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {

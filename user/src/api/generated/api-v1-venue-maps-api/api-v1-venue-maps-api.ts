 ...
 */
export const postApiV1GetRefinementVenueMaps = async (apiV1VenueMapsApiBody?: ApiV1VenueMapsApiBody, options?: RequestInit): Promise<postApiV1GetRefinementVenueMapsResponse> => {
  ...
  return openApiFetch<postApiV1GetRefinementVenueMapsResponse>(getPostApiV1GetRefinementVenueMapsUrl(),
  {
    ...
    body: JSON.stringify(apiV1VenueMapsApiBody)
  }
);}
...
export const getPostApiV1GetRefinementVenueMapsMutationFetcher = ( options?: SecondParameter<typeof openApiFetch>) => {
  return (_: Key, { arg }: { arg: ApiV1VenueMapsApiBody | undefined }) => {
...
export const usePostApiV1GetRefinementVenueMaps = <TError = ApiV1VenueMapsApi>(
   options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof postApiV1GetRefinementVenueMaps>>, TError, Key, ApiV1VenueMapsApiBody | undefined, Awaited<ReturnType<typeof postApiV1GetRefinementVenueMaps>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {
 ...
 * @summary post summary
 */
export const postApiV1GetSearchVenueMaps = async (apiV1VenueMapsApiBody?: ApiV1VenueMapsApiBody, options?: RequestInit): Promise<postApiV1GetSearchVenueMapsResponse> => {
...
export const usePostApiV1GetSearchVenueMaps = <TError = ApiV1VenueMapsApi>(
   options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof postApiV1GetSearchVenueMaps>>, TError, Key, ApiV1VenueMapsApiBody | undefined, Awaited<ReturnType<typeof postApiV1GetSearchVenueMaps>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {

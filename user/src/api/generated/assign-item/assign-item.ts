 ...
 */
export const postAssignItems = async (assignItemBody?: AssignItemBody, options?: RequestInit): Promise<postAssignItemsResponse> => {
...
export const getPostAssignItemsMutationFetcher = ( options?: SecondParameter<typeof openApiFetch>) => {
  return (_: Key, { arg }: { arg: AssignItemBody | undefined }) => {
...
export const usePostAssignItems = <TError = AssignItem>(
   options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof postAssignItems>>, TError, Key, AssignItemBody | undefined, Awaited<ReturnType<typeof postAssignItems>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {
...
export const patchAssignItemsId = async (id: number,
    assignItemBody?: AssignItemBody, options?: RequestInit): Promise<patchAssignItemsIdResponse> => {
...
export const usePatchAssignItemsId = <TError = void | AssignItem>(
  id: number, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof patchAssignItemsId>>, TError, Key, AssignItemBody | undefined, Awaited<ReturnType<typeof patchAssignItemsId>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {
...
export const putAssignItemsId = async (id: number,
    assignItemBody?: AssignItemBody, options?: RequestInit): Promise<putAssignItemsIdResponse> => {
...
export const usePutAssignItemsId = <TError = void | AssignItem>(
  id: number, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof putAssignItemsId>>, TError, Key, AssignItemBody | undefined, Awaited<ReturnType<typeof putAssignItemsId>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {

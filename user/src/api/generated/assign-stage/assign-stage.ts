 ...
 */
export const postAssignStages = async (assignStageBody?: AssignStageBody, options?: RequestInit): Promise<postAssignStagesResponse> => {
  ...
  return openApiFetch<postAssignStagesResponse>(getPostAssignStagesUrl(),
  {
    ...
    body: JSON.stringify(assignStageBody)
  }
);}
...
export const getPostAssignStagesMutationFetcher = ( options?: SecondParameter<typeof openApiFetch>) => {
  return (_: Key, { arg }: { arg: AssignStageBody | undefined }) => {
...
export const usePostAssignStages = <TError = AssignStage>(
   options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof postAssignStages>>, TError, Key, AssignStageBody | undefined, Awaited<ReturnType<typeof postAssignStages>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {
...
export const patchAssignStagesId = async (id: number,
    assignStageBody?: AssignStageBody, options?: RequestInit): Promise<patchAssignStagesIdResponse> => {
...
export const usePatchAssignStagesId = <TError = void | AssignStage>(
  id: number, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof patchAssignStagesId>>, TError, Key, AssignStageBody | undefined, Awaited<ReturnType<typeof patchAssignStagesId>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {
...
export const putAssignStagesId = async (id: number,
    assignStageBody?: AssignStageBody, options?: RequestInit): Promise<putAssignStagesIdResponse> => {
...
export const usePutAssignStagesId = <TError = void | AssignStage>(
  id: number, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof putAssignStagesId>>, TError, Key, AssignStageBody | undefined, Awaited<ReturnType<typeof putAssignStagesId>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {

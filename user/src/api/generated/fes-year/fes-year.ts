 ...
 */
export const postFesYears = async (fesYearBody?: FesYearBody, options?: RequestInit): Promise<postFesYearsResponse> => {
  ...
  return openApiFetch<postFesYearsResponse>(getPostFesYearsUrl(),
  {
    ...
    body: JSON.stringify(fesYearBody)
  }
);}
...
export const getPostFesYearsMutationFetcher = ( options?: SecondParameter<typeof openApiFetch>) => {
  return (_: Key, { arg }: { arg: FesYearBody | undefined }) => {
...
export const usePostFesYears = <TError = FesYear>(
   options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof postFesYears>>, TError, Key, FesYearBody | undefined, Awaited<ReturnType<typeof postFesYears>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {
...
export const patchFesYearsId = async (id: number,
    fesYearBody?: FesYearBody, options?: RequestInit): Promise<patchFesYearsIdResponse> => {
...
export const usePatchFesYearsId = <TError = void | FesYear>(
  id: number, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof patchFesYearsId>>, TError, Key, FesYearBody | undefined, Awaited<ReturnType<typeof patchFesYearsId>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {
...
export const putFesYearsId = async (id: number,
    fesYearBody?: FesYearBody, options?: RequestInit): Promise<putFesYearsIdResponse> => {
...
export const usePutFesYearsId = <TError = void | FesYear>(
  id: number, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof putFesYearsId>>, TError, Key, FesYearBody | undefined, Awaited<ReturnType<typeof putFesYearsId>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {

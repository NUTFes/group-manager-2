 ...
 */
export const postFoodProducts = async (foodProductBody?: FoodProductBody, options?: RequestInit): Promise<postFoodProductsResponse> => {
  ...
  return openApiFetch<postFoodProductsResponse>(getPostFoodProductsUrl(),
  {
    ...
    body: JSON.stringify(foodProductBody)
  }
);}
...
export const getPostFoodProductsMutationFetcher = ( options?: SecondParameter<typeof openApiFetch>) => {
  return (_: Key, { arg }: { arg: FoodProductBody | undefined }) => {
...
export const usePostFoodProducts = <TError = FoodProduct>(
   options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof postFoodProducts>>, TError, Key, FoodProductBody | undefined, Awaited<ReturnType<typeof postFoodProducts>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {
 ...
 */
export const patchFoodProducts = async (foodProductBody?: FoodProductBody, options?: RequestInit): Promise<patchFoodProductsResponse> => {
...
export const usePatchFoodProducts = <TError = FoodProduct>(
   options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof patchFoodProducts>>, TError, Key, FoodProductBody | undefined, Awaited<ReturnType<typeof patchFoodProducts>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {
...
export const patchFoodProductsId = async (id: number,
    foodProductBody?: FoodProductBody, options?: RequestInit): Promise<patchFoodProductsIdResponse> => {
...
export const usePatchFoodProductsId = <TError = void | FoodProduct>(
  id: number, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof patchFoodProductsId>>, TError, Key, FoodProductBody | undefined, Awaited<ReturnType<typeof patchFoodProductsId>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {
...
export const putFoodProductsId = async (id: number,
    foodProductBody?: FoodProductBody, options?: RequestInit): Promise<putFoodProductsIdResponse> => {
...
export const usePutFoodProductsId = <TError = void | FoodProduct>(
  id: number, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof putFoodProductsId>>, TError, Key, FoodProductBody | undefined, Awaited<ReturnType<typeof putFoodProductsId>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {
 ...
 * @summary post summary
 */
export const postFoodProductsBulkUpsert = async (foodProductBody?: FoodProductBody, options?: RequestInit): Promise<postFoodProductsBulkUpsertResponse> => {
...
export const usePostFoodProductsBulkUpsert = <TError = FoodProduct>(
   options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof postFoodProductsBulkUpsert>>, TError, Key, FoodProductBody | undefined, Awaited<ReturnType<typeof postFoodProductsBulkUpsert>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {
 ...
 * @summary post summary
 */
export const postFoodProductsUpsert = async (foodProductBody?: FoodProductBody, options?: RequestInit): Promise<postFoodProductsUpsertResponse> => {
...
export const usePostFoodProductsUpsert = <TError = FoodProduct>(
   options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof postFoodProductsUpsert>>, TError, Key, FoodProductBody | undefined, Awaited<ReturnType<typeof postFoodProductsUpsert>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {

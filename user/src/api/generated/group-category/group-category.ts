 ...
 */
export const postGroupCategories = async (groupCategoryBody?: GroupCategoryBody, options?: RequestInit): Promise<postGroupCategoriesResponse> => {
  ...
  return openApiFetch<postGroupCategoriesResponse>(getPostGroupCategoriesUrl(),
  {
    ...
    body: JSON.stringify(groupCategoryBody)
  }
);}
...
export const getPostGroupCategoriesMutationFetcher = ( options?: SecondParameter<typeof openApiFetch>) => {
  return (_: Key, { arg }: { arg: GroupCategoryBody | undefined }) => {
...
export const usePostGroupCategories = <TError = GroupCategory>(
   options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof postGroupCategories>>, TError, Key, GroupCategoryBody | undefined, Awaited<ReturnType<typeof postGroupCategories>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {
...
export const patchGroupCategoriesId = async (id: number,
    groupCategoryBody?: GroupCategoryBody, options?: RequestInit): Promise<patchGroupCategoriesIdResponse> => {
...
export const usePatchGroupCategoriesId = <TError = void | GroupCategory>(
  id: number, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof patchGroupCategoriesId>>, TError, Key, GroupCategoryBody | undefined, Awaited<ReturnType<typeof patchGroupCategoriesId>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {
...
export const putGroupCategoriesId = async (id: number,
    groupCategoryBody?: GroupCategoryBody, options?: RequestInit): Promise<putGroupCategoriesIdResponse> => {
...
export const usePutGroupCategoriesId = <TError = void | GroupCategory>(
  id: number, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof putGroupCategoriesId>>, TError, Key, GroupCategoryBody | undefined, Awaited<ReturnType<typeof putGroupCategoriesId>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {

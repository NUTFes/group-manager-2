 ...
 */
export const postGroups = async (groupBody?: GroupBody, options?: RequestInit): Promise<postGroupsResponse> => {
...
export const getPostGroupsMutationFetcher = ( options?: SecondParameter<typeof openApiFetch>) => {
  return (_: Key, { arg }: { arg: GroupBody | undefined }) => {
...
export const usePostGroups = <TError = Group>(
   options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof postGroups>>, TError, Key, GroupBody | undefined, Awaited<ReturnType<typeof postGroups>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {
...
export const patchGroupsId = async (id: number,
    groupBody?: GroupBody, options?: RequestInit): Promise<patchGroupsIdResponse> => {
...
export const usePatchGroupsId = <TError = void | Group>(
  id: number, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof patchGroupsId>>, TError, Key, GroupBody | undefined, Awaited<ReturnType<typeof patchGroupsId>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {
...
export const putGroupsId = async (id: number,
    groupBody?: GroupBody, options?: RequestInit): Promise<putGroupsIdResponse> => {
...
export const usePutGroupsId = <TError = void | Group>(
  id: number, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof putGroupsId>>, TError, Key, GroupBody | undefined, Awaited<ReturnType<typeof putGroupsId>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {

 ...
 */
export const postMemos = async (memoBody?: MemoBody, options?: RequestInit): Promise<postMemosResponse> => {
...
export const getPostMemosMutationFetcher = ( options?: SecondParameter<typeof openApiFetch>) => {
  return (_: Key, { arg }: { arg: MemoBody | undefined }) => {
...
export const usePostMemos = <TError = Memo>(
   options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof postMemos>>, TError, Key, MemoBody | undefined, Awaited<ReturnType<typeof postMemos>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {
...
export const patchMemosId = async (id: number,
    memoBody?: MemoBody, options?: RequestInit): Promise<patchMemosIdResponse> => {
...
export const usePatchMemosId = <TError = void | Memo>(
  id: number, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof patchMemosId>>, TError, Key, MemoBody | undefined, Awaited<ReturnType<typeof patchMemosId>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {
...
export const putMemosId = async (id: number,
    memoBody?: MemoBody, options?: RequestInit): Promise<putMemosIdResponse> => {
...
export const usePutMemosId = <TError = void | Memo>(
  id: number, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof putMemosId>>, TError, Key, MemoBody | undefined, Awaited<ReturnType<typeof putMemosId>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {

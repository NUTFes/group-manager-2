 ...
 */
export const postNews = async (newsBody?: NewsBody, options?: RequestInit): Promise<postNewsResponse> => {
...
export const getPostNewsMutationFetcher = ( options?: SecondParameter<typeof openApiFetch>) => {
  return (_: Key, { arg }: { arg: NewsBody | undefined }) => {
...
export const usePostNews = <TError = News>(
   options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof postNews>>, TError, Key, NewsBody | undefined, Awaited<ReturnType<typeof postNews>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {
...
export const patchNewsId = async (id: number,
    newsBody?: NewsBody, options?: RequestInit): Promise<patchNewsIdResponse> => {
...
export const usePatchNewsId = <TError = void | News>(
  id: number, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof patchNewsId>>, TError, Key, NewsBody | undefined, Awaited<ReturnType<typeof patchNewsId>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {
...
export const putNewsId = async (id: number,
    newsBody?: NewsBody, options?: RequestInit): Promise<putNewsIdResponse> => {
...
export const usePutNewsId = <TError = void | News>(
  id: number, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof putNewsId>>, TError, Key, NewsBody | undefined, Awaited<ReturnType<typeof putNewsId>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {

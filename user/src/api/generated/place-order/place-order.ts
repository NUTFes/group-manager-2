 ...
 */
export const postPlaceOrders = async (placeOrderBody?: PlaceOrderBody, options?: RequestInit): Promise<postPlaceOrdersResponse> => {
...
export const getPostPlaceOrdersMutationFetcher = ( options?: SecondParameter<typeof openApiFetch>) => {
  return (_: Key, { arg }: { arg: PlaceOrderBody | undefined }) => {
...
export const usePostPlaceOrders = <TError = PlaceOrder>(
   options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof postPlaceOrders>>, TError, Key, PlaceOrderBody | undefined, Awaited<ReturnType<typeof postPlaceOrders>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {
...
export const patchPlaceOrdersId = async (id: number,
    placeOrderBody?: PlaceOrderBody, options?: RequestInit): Promise<patchPlaceOrdersIdResponse> => {
...
export const usePatchPlaceOrdersId = <TError = void | PlaceOrder>(
  id: number, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof patchPlaceOrdersId>>, TError, Key, PlaceOrderBody | undefined, Awaited<ReturnType<typeof patchPlaceOrdersId>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {
...
export const putPlaceOrdersId = async (id: number,
    placeOrderBody?: PlaceOrderBody, options?: RequestInit): Promise<putPlaceOrdersIdResponse> => {
...
export const usePutPlaceOrdersId = <TError = void | PlaceOrder>(
  id: number, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof putPlaceOrdersId>>, TError, Key, PlaceOrderBody | undefined, Awaited<ReturnType<typeof putPlaceOrdersId>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {

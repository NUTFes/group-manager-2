 ...
 */
export const postPowerOrders = async (powerOrderBody?: PowerOrderBody, options?: RequestInit): Promise<postPowerOrdersResponse> => {
  ...
  return openApiFetch<postPowerOrdersResponse>(getPostPowerOrdersUrl(),
  {
    ...
    body: JSON.stringify(powerOrderBody)
  }
);}
...
export const getPostPowerOrdersMutationFetcher = ( options?: SecondParameter<typeof openApiFetch>) => {
  return (_: Key, { arg }: { arg: PowerOrderBody | undefined }) => {
...
export const usePostPowerOrders = <TError = PowerOrder>(
   options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof postPowerOrders>>, TError, Key, PowerOrderBody | undefined, Awaited<ReturnType<typeof postPowerOrders>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {
...
export const patchPowerOrdersId = async (id: number,
    powerOrderBody?: PowerOrderBody, options?: RequestInit): Promise<patchPowerOrdersIdResponse> => {
...
export const usePatchPowerOrdersId = <TError = void | PowerOrder>(
  id: number, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof patchPowerOrdersId>>, TError, Key, PowerOrderBody | undefined, Awaited<ReturnType<typeof patchPowerOrdersId>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {
...
export const putPowerOrdersId = async (id: number,
    powerOrderBody?: PowerOrderBody, options?: RequestInit): Promise<putPowerOrdersIdResponse> => {
...
export const usePutPowerOrdersId = <TError = void | PowerOrder>(
  id: number, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof putPowerOrdersId>>, TError, Key, PowerOrderBody | undefined, Awaited<ReturnType<typeof putPowerOrdersId>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {

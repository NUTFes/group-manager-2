...
import type {
  ...
  RailsConductorActionmailboxRerouteBody
} from '../schemas';
...
export const postRailsConductorActionMailboxInboundEmailIdReroute = async (inboundEmailId: number,
    railsConductorActionmailboxRerouteBody?: RailsConductorActionmailboxRerouteBody, options?: RequestInit): Promise<postRailsConductorActionMailboxInboundEmailIdRerouteResponse> => {
  ...
  return openApiFetch<postRailsConductorActionMailboxInboundEmailIdRerouteResponse>(getPostRailsConductorActionMailboxInboundEmailIdRerouteUrl(inboundEmailId),
  {
    ...
    body: JSON.stringify(railsConductorActionmailboxRerouteBody)
  }
);}
...
export const getPostRailsConductorActionMailboxInboundEmailIdRerouteMutationFetcher = (inboundEmailId: number, options?: SecondParameter<typeof openApiFetch>) => {
  return (_: Key, { arg }: { arg: RailsConductorActionmailboxRerouteBody | undefined }) => {
...
export const usePostRailsConductorActionMailboxInboundEmailIdReroute = <TError = void | RailsConductorActionmailboxReroute>(
  inboundEmailId: number, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof postRailsConductorActionMailboxInboundEmailIdReroute>>, TError, Key, RailsConductorActionmailboxRerouteBody | undefined, Awaited<ReturnType<typeof postRailsConductorActionMailboxInboundEmailIdReroute>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {

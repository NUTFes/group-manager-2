 ...
 */
export const postStageNumbers = async (stageNumberBody?: StageNumberBody, options?: RequestInit): Promise<postStageNumbersResponse> => {
  ...
  return openApiFetch<postStageNumbersResponse>(getPostStageNumbersUrl(),
  {
    ...
    body: JSON.stringify(stageNumberBody)
  }
);}
...
export const getPostStageNumbersMutationFetcher = ( options?: SecondParameter<typeof openApiFetch>) => {
  return (_: Key, { arg }: { arg: StageNumberBody | undefined }) => {
...
export const usePostStageNumbers = <TError = StageNumber>(
   options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof postStageNumbers>>, TError, Key, StageNumberBody | undefined, Awaited<ReturnType<typeof postStageNumbers>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {
...
export const putStageNumbersId = async (id: number,
    stageNumberBody?: StageNumberBody, options?: RequestInit): Promise<putStageNumbersIdResponse> => {
...
export const usePutStageNumbersId = <TError = void | StageNumber>(
  id: number, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof putStageNumbersId>>, TError, Key, StageNumberBody | undefined, Awaited<ReturnType<typeof putStageNumbersId>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {

 ...
 */
export const postStageOrders = async (stageOrderBody?: StageOrderBody, options?: RequestInit): Promise<postStageOrdersResponse> => {
  ...
  return openApiFetch<postStageOrdersResponse>(getPostStageOrdersUrl(),
  {
    ...
    body: JSON.stringify(stageOrderBody)
  }
);}
...
export const getPostStageOrdersMutationFetcher = ( options?: SecondParameter<typeof openApiFetch>) => {
  return (_: Key, { arg }: { arg: StageOrderBody | undefined }) => {
...
export const usePostStageOrders = <TError = StageOrder>(
   options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof postStageOrders>>, TError, Key, StageOrderBody | undefined, Awaited<ReturnType<typeof postStageOrders>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {
...
export const patchStageOrdersId = async (id: number,
    stageOrderBody?: StageOrderBody, options?: RequestInit): Promise<patchStageOrdersIdResponse> => {
...
export const usePatchStageOrdersId = <TError = void | StageOrder>(
  id: number, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof patchStageOrdersId>>, TError, Key, StageOrderBody | undefined, Awaited<ReturnType<typeof patchStageOrdersId>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {
...
export const putStageOrdersId = async (id: number,
    stageOrderBody?: StageOrderBody, options?: RequestInit): Promise<putStageOrdersIdResponse> => {
...
export const usePutStageOrdersId = <TError = void | StageOrder>(
  id: number, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof putStageOrdersId>>, TError, Key, StageOrderBody | undefined, Awaited<ReturnType<typeof putStageOrdersId>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {

 ...
 */
export const postStockerItems = async (stockerItemBody?: StockerItemBody, options?: RequestInit): Promise<postStockerItemsResponse> => {
  ...
  return openApiFetch<postStockerItemsResponse>(getPostStockerItemsUrl(),
  {
    ...
    body: JSON.stringify(stockerItemBody)
  }
);}
...
export const getPostStockerItemsMutationFetcher = ( options?: SecondParameter<typeof openApiFetch>) => {
  return (_: Key, { arg }: { arg: StockerItemBody | undefined }) => {
...
export const usePostStockerItems = <TError = StockerItem>(
   options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof postStockerItems>>, TError, Key, StockerItemBody | undefined, Awaited<ReturnType<typeof postStockerItems>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {
...
export const patchStockerItemsId = async (id: number,
    stockerItemBody?: StockerItemBody, options?: RequestInit): Promise<patchStockerItemsIdResponse> => {
...
export const usePatchStockerItemsId = <TError = void | StockerItem>(
  id: number, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof patchStockerItemsId>>, TError, Key, StockerItemBody | undefined, Awaited<ReturnType<typeof patchStockerItemsId>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {
...
export const putStockerItemsId = async (id: number,
    stockerItemBody?: StockerItemBody, options?: RequestInit): Promise<putStockerItemsIdResponse> => {
...
export const usePutStockerItemsId = <TError = void | StockerItem>(
  id: number, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof putStockerItemsId>>, TError, Key, StockerItemBody | undefined, Awaited<ReturnType<typeof putStockerItemsId>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {

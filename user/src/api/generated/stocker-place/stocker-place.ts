 ...
 */
export const postStockerPlaces = async (stockerPlaceBody?: StockerPlaceBody, options?: RequestInit): Promise<postStockerPlacesResponse> => {
  ...
  return openApiFetch<postStockerPlacesResponse>(getPostStockerPlacesUrl(),
  {
    ...
    body: JSON.stringify(stockerPlaceBody)
  }
);}
...
export const getPostStockerPlacesMutationFetcher = ( options?: SecondParameter<typeof openApiFetch>) => {
  return (_: Key, { arg }: { arg: StockerPlaceBody | undefined }) => {
...
export const usePostStockerPlaces = <TError = StockerPlace>(
   options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof postStockerPlaces>>, TError, Key, StockerPlaceBody | undefined, Awaited<ReturnType<typeof postStockerPlaces>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {
...
export const patchStockerPlacesId = async (id: number,
    stockerPlaceBody?: StockerPlaceBody, options?: RequestInit): Promise<patchStockerPlacesIdResponse> => {
...
export const usePatchStockerPlacesId = <TError = void | StockerPlace>(
  id: number, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof patchStockerPlacesId>>, TError, Key, StockerPlaceBody | undefined, Awaited<ReturnType<typeof patchStockerPlacesId>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {
...
export const putStockerPlacesId = async (id: number,
    stockerPlaceBody?: StockerPlaceBody, options?: RequestInit): Promise<putStockerPlacesIdResponse> => {
...
export const usePutStockerPlacesId = <TError = void | StockerPlace>(
  id: number, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof putStockerPlacesId>>, TError, Key, StockerPlaceBody | undefined, Awaited<ReturnType<typeof putStockerPlacesId>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {

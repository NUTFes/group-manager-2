 ...
 */
export const postUserPageSettings = async (userPageSettingBody?: UserPageSettingBody, options?: RequestInit): Promise<postUserPageSettingsResponse> => {
  ...
  return openApiFetch<postUserPageSettingsResponse>(getPostUserPageSettingsUrl(),
  {
    ...
    body: JSON.stringify(userPageSettingBody)
  }
);}
...
export const getPostUserPageSettingsMutationFetcher = ( options?: SecondParameter<typeof openApiFetch>) => {
  return (_: Key, { arg }: { arg: UserPageSettingBody | undefined }) => {
...
export const usePostUserPageSettings = <TError = UserPageSetting>(
   options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof postUserPageSettings>>, TError, Key, UserPageSettingBody | undefined, Awaited<ReturnType<typeof postUserPageSettings>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {
...
export const patchUserPageSettingsId = async (id: number,
    userPageSettingBody?: UserPageSettingBody, options?: RequestInit): Promise<patchUserPageSettingsIdResponse> => {
...
export const usePatchUserPageSettingsId = <TError = void | UserPageSetting>(
  id: number, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof patchUserPageSettingsId>>, TError, Key, UserPageSettingBody | undefined, Awaited<ReturnType<typeof patchUserPageSettingsId>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {
...
export const putUserPageSettingsId = async (id: number,
    userPageSettingBody?: UserPageSettingBody, options?: RequestInit): Promise<putUserPageSettingsIdResponse> => {
...
export const usePutUserPageSettingsId = <TError = void | UserPageSetting>(
  id: number, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof putUserPageSettingsId>>, TError, Key, UserPageSettingBody | undefined, Awaited<ReturnType<typeof putUserPageSettingsId>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {

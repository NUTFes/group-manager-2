...
export const getPutUsersIdMutationFetcher = (id: number, options?: SecondParameter<typeof openApiFetch>) => {
  return (_: Key, { arg }: { arg: UserBody | undefined }) => {
...
export const usePutUsersId = <TError = void | User>(
  id: number, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof putUsersId>>, TError, Key, UserBody | undefined, Awaited<ReturnType<typeof putUsersId>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {
 ...
 */
export const postUsersSimplyUserCreate = async (userBody?: UserBody, options?: RequestInit): Promise<postUsersSimplyUserCreateResponse> => {
...
export const usePostUsersSimplyUserCreate = <TError = User>(
   options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof postUsersSimplyUserCreate>>, TError, Key, UserBody | undefined, Awaited<ReturnType<typeof postUsersSimplyUserCreate>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {

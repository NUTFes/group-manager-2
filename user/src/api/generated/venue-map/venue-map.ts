 ...
 */
export const postVenueMaps = async (venueMapBody?: VenueMapBody, options?: RequestInit): Promise<postVenueMapsResponse> => {
  ...
  return openApiFetch<postVenueMapsResponse>(getPostVenueMapsUrl(),
  {
    ...
    body: JSON.stringify(venueMapBody)
  }
);}
...
export const getPostVenueMapsMutationFetcher = ( options?: SecondParameter<typeof openApiFetch>) => {
  return (_: Key, { arg }: { arg: VenueMapBody | undefined }) => {
...
export const usePostVenueMaps = <TError = VenueMap>(
   options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof postVenueMaps>>, TError, Key, VenueMapBody | undefined, Awaited<ReturnType<typeof postVenueMaps>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {
...
export const patchVenueMapsId = async (id: number,
    venueMapBody?: VenueMapBody, options?: RequestInit): Promise<patchVenueMapsIdResponse> => {
...
export const usePatchVenueMapsId = <TError = void | VenueMap>(
  id: number, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof patchVenueMapsId>>, TError, Key, VenueMapBody | undefined, Awaited<ReturnType<typeof patchVenueMapsId>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {
...
export const putVenueMapsId = async (id: number,
    venueMapBody?: VenueMapBody, options?: RequestInit): Promise<putVenueMapsIdResponse> => {
...
export const usePutVenueMapsId = <TError = void | VenueMap>(
  id: number, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof putVenueMapsId>>, TError, Key, VenueMapBody | undefined, Awaited<ReturnType<typeof putVenueMapsId>>> & { swrKey?: string }, request?: SecondParameter<typeof openApiFetch>}
) => {

...
export const rentItemsFormSchema = z
    ...
    .refine(
        (data) => {
            ...
            const hasPartition = data.items.some(item => item.itemId === ITEM_IDS.PARTITION);
            const hasDisplayBoard = data.items.some(item => item.itemId === ITEM_IDS.DISPLAY_BOARD);
    ...
    .refine(
        (data) => {
            ...
            const longTableItem = data.items.find(item => item.itemId === ITEM_IDS.LONG_TABLE);
    ...
    .refine(
        (data) => {
            ...
            const tableItem = data.items.find(item => item.itemId === ITEM_IDS.TABLE);
    ...
    .refine(
        (data) => {
            ...
            const chairItem = data.items.find(item => item.itemId === ITEM_IDS.CHAIR);

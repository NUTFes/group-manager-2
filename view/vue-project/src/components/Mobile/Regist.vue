      ...
      <v-row>
        <v-col>
          <v-tabs vertical color="btn">
            <v-tab :value="tab - 1" class="mx-n3">
              <v-icon>mdi-account-group</v-icon>
            </v-tab>
            <v-tab :value="tab - 2" class="mx-n3">
              <v-icon class="">mdi-account-multiple</v-icon>
            </v-tab>

            <v-tab :value="tab - 3" class="mx-n3">
              <v-icon class="">mdi-map-marker</v-icon>
            </v-tab>

            <v-tab :value="tab - 4" class="mx-n3">
              <v-icon class="">mdi-power-plug</v-icon>
            </v-tab>

            <v-tab :value="tab - 5" class="mx-n3">
              <v-icon class="">mdi-table-chair</v-icon>
            </v-tab>

            <v-tab :value="tab - 6" class="mx-n3">
              <v-icon class="">mdi-microphone</v-icon>
            </v-tab>

            <v-tab :value="tab - 7" class="mx-n3">
              <v-icon class="">mdi-microphone-plus</v-icon>
            </v-tab>

            <v-tab :value="tab - 8" class="mx-n3">
              <v-icon class="">mdi-account</v-icon>
            </v-tab>

            <v-tab :value="tab - 9" class="mx-n3">
              <v-icon class="">mdi-baguette</v-icon>
            </v-tab>

            <v-tab :value="tab - 10" class="mx-n3">
            ...
            <v-tab-item>
              <v-row>
                <v-col>
                  <v-card flat>
                    <v-card-title>
                      <v-icon class="pr-2" size="30">mdi-account-group</v-icon
                      ><b>団体情報</b>
                      <v-spacer></v-spacer>
                      <v-tooltip top>
                        <template v-slot:activator="{ on, attrs }">
                    ...
                    <v-list>
                      ...
                      <v-list-item>
                        ...
                        <v-list-item-content
                          v-if="regist.group.project_name == -9999"
                          >未登録</v-list-item-content
                        >
                        <v-list-item-content v-else>{{
                      ...
                      <v-list-item>
                        ...
                        <v-list-item-content
                          v-if="regist.group_category == -9999"
                          >未登録</v-list-item-content
                        >
                        <v-list-item-content v-else>{{
                      ...
                      <v-list-item>
                        ...
                        <v-list-item-content
                          v-if="regist.group.activity == -9999"
                          >未登録</v-list-item-content
                        >
                        <v-list-item-content v-else>{{
                  ...
                  <v-card flat>
                    ...
                    <v-list>
                      ...
                      <v-list-item>
                        ...
                        <v-list-item-content
                          v-if="regist.sub_rep.student_id == -9999"
                          >未登録</v-list-item-content
                        >
                        <v-list-item-content v-else>{{
                      ...
                      <v-list-item>
                        ...
                        <v-list-item-content
                          v-if="regist.sub_rep.department_id == -9999"
                          >未登録</v-list-item-content
                        >
                        <v-list-item-content v-else>{{
                      ...
                      <v-list-item>
                        ...
                        <v-list-item-content
                          v-if="regist.sub_rep.grade_id == -9999"
                          >未登録</v-list-item-content
                        >
                        <v-list-item-content v-else>{{
                      ...
                      <v-list-item>
                        <v-list-item-content
                          >メールアドレス</v-list-item-content
                        >
                        <v-list-item-content
                          v-if="regist.sub_rep.email == -9999"
                          >未登録</v-list-item-content
                        >
                        <v-list-item-content v-else>{{
            ...
            <v-tab-item>
              <v-row>
                <v-col>
                  <v-card flat>
                    <v-card-title>
                      <v-icon class="pr-2" size="30">mdi-map-marker</v-icon
                      ><b>会場申請情報</b>
                      <v-spacer></v-spacer>
                      <v-tooltip top>
                        <template v-slot:activator="{ on, attrs }">
                    ...
                    <hr />
                    <v-card-text v-if="regist.first_place_order == -9999"
                      >未登録</v-card-text
                    >
                    <v-list v-else>
                      <v-list-item>
                        ...
                        <v-list-item-content
                          v-if="regist.first_place_order == -9999"
                          >未登録</v-list-item-content
                        >
                        <v-list-item-content v-else>{{
                      ...
                      <v-list-item>
                        ...
                        <v-list-item-content
                          v-if="regist.second_place_order == -9999"
                          >未登録</v-list-item-content
                        >
                        <v-list-item-content v-else>{{
                      ...
                      <v-list-item>
                        ...
                        <v-list-item-content
                          v-if="regist.third_place_order == -9999"
                          >未登録</v-list-item-content
                        >
                        <v-list-item-content v-else>{{
                  ...
                  <v-card flat>
                    ...
                    <v-list>
                      <v-list-item>
                        ...
                        <v-list-item-content v-if="power_order.item == -9999"
                          >未登録</v-list-item-content
                        >
                        <v-list-item-content v-else>{{
                          power_order.item
                      ...
                      <v-list-item>
                        ...
                        <v-list-item-content v-if="power_order.power == -9999"
                          >未登録</v-list-item-content
                        >
                        <v-list-item-content v-else>{{
                          power_order.power
                      ...
                      <v-list-item>
                        ...
                        <v-list-item-content
                          v-if="power_order.manufacturer == -9999"
                          >未登録</v-list-item-content
                        >
                        <v-list-item-content v-else>{{
                          power_order.manufacturer
                      ...
                      <v-list-item>
                        ...
                        <v-list-item-content v-if="power_order.model == -9999"
                          >未登録</v-list-item-content
                        >
                        <v-list-item-content v-else>{{
                          power_order.model
                      ...
                      <v-list-item>
                        ...
                        <v-list-item-content
                          v-if="power_order.item_url == -9999"
                          >未登録</v-list-item-content
                        >
                        <v-list-item-content v-else>{{
                          power_order.item_url
                  ...
                  <v-card flat>
                          ...
                          <v-btn
                            ...
                            @click="
                              openStageOrderDisplay(
                                stage_order.id,
                                stage_order.group_id,
                                stage_order.is_sunny,
                                stage_order.stage_date.id,
                                stage_order.first_stage_order.id,
                                stage_order.second_stage_order.id,
                    ...
                    <v-list>
                      <v-list-item>
                        ...
                        <v-list-item-content
                          v-if="stage_order.stage_date.id == -9999"
                          >未登録</v-list-item-content
                        >
                        <v-list-item-content v-else>{{
                          stage_order.stage_date.date
                        }}</v-list-item-content>
                      </v-list-item>
                      <v-divider></v-divider>
                      <v-list-item>
                        ...
                        <v-list-item-content
                          v-if="stage_order.is_sunny == -9999"
                          >未登録</v-list-item-content
                        >
                        <v-list-item-content
                          v-else-if="stage_order.is_sunny == true"
                          >晴れ</v-list-item-content
                        >
                      ...
                      <v-list-item>
                        ...
                        <v-list-item-content
                          v-if="stage_order.first_stage_order == -9999"
                          >未登録</v-list-item-content
                        >
                        <v-list-item-content v-else>{{
                          stage_order.first_stage_order.name
                        }}</v-list-item-content>
                      </v-list-item>
                      <v-divider></v-divider>
                      <v-list-item>
                        ...
                        >
                        <v-list-item-content v-else>{{
                          stage_order.second_stage_order.name
                        }}</v-list-item-content>
                      </v-list-item>
                      <v-divider></v-divider>
                      <v-list-item>
                      ...
                      <v-list-item>
                        ...
                        <v-list-item-content
                          v-if="stage_order.use_time_interval == -9999"
                          >未登録</v-list-item-content
                        >
                        <v-list-item-content v-else>{{
                          stage_order.use_time_interval
                      ...
                      <v-list-item>
                        ...
                        <v-list-item-content
                          v-if="stage_order.cleanup_end_time == -9999"
                          >未登録</v-list-item-content
                        >
                        <v-list-item-content v-else>{{
                          stage_order.cleanup_end_time
                ...
                <v-col>
                  <v-card flat>
                    ...
                    <v-list>
                      <v-list-item>
                        <v-list-item-content
                          >所持機器の使用</v-list-item-content
                        >
                        <v-list-item-content
                          v-if="
                            regist.stage_common_option.own_equipment == -9999
                          "
                          >未登録</v-list-item-content
                        >
                        <v-list-item-content
                          v-else-if="
                            regist.stage_common_option.own_equipment === true
                          "
                          >使用</v-list-item-content
                        >
                        <v-list-item-content v-else
                          >使用しない</v-list-item-content
                        >
                      </v-list-item>
                      <v-divider></v-divider>
                      <v-list-item>
                        ...
                        <v-list-item-content
                          v-if="regist.stage_common_option.bgm == -9999"
                          >未登録</v-list-item-content
                        >
                        <v-list-item-content
                          v-else-if="regist.stage_common_option.bgm === true"
                          >使用</v-list-item-content
                        >
                        <v-list-item-content v-else
                          >使用しない</v-list-item-content
                      ...
                      <v-list-item>
                        ...
                        <v-list-item-content
                          v-if="
                            regist.stage_common_option.camera_permission ==
                            -9999
                          "
                          >未登録</v-list-item-content
                        >
                        <v-list-item-content
                          v-else-if="
                            ...
                            true
                          "
                          >許可</v-list-item-content
                        >
                        <v-list-item-content v-else
                          >許可しない</v-list-item-content
                        >
                      </v-list-item>
                      <v-divider></v-divider>
                      <v-list-item>
                        ...
                        <v-list-item-content
                          v-if="regist.stage_common_option.loud_sound == -9999"
                          >未登録</v-list-item-content
                        >
                        <v-list-item-content
                          v-else-if="
                            regist.stage_common_option.loud_sound === true
                          "
                          >出す</v-list-item-content
                        >
                        <v-list-item-content v-else
                          >出さない</v-list-item-content
                        >
                      </v-list-item>
                      <v-divider></v-divider>
                      <v-list-item>
                        ...
                        <v-list-item-content
                          v-if="
                            regist.stage_common_option.stage_content == -9999
                          "
                          >未登録</v-list-item-content
                        >
                        <v-list-item-content v-else>{{
                          regist.stage_common_option.stage_content
                        }}</v-list-item-content>
                      </v-list-item>
                    </v-list>
                  </v-card>
                  ...
                  <v-card flat>
                    ...
                    <v-list>
                      <v-list-item>
                        ...
                        <v-list-item-content v-if="employee.name == -9999"
                          >未登録</v-list-item-content
                        >
                        <v-list-item-content v-else>{{
                          employee.name
                      ...
                      <v-list-item>
                        <v-list-item-content>学籍番号</v-list-item-content>
                        <v-list-item-content v-if="employee.student_id == -9999"
                          >未登録</v-list-item-content
                        >
                        <v-list-item-content v-else>{{
                          employee.student_id
                  ...
                  <v-card flat>
                      ...
                      <v-tooltip top>
                        <template v-slot:activator="{ on, attrs }">
                          <v-btn
                            ...
                            v-on="on"
                            @click="
                              openFoodProductDisplay(
                                food_product.id,
                                food_product.group_id,
                                food_product.name,
                    ...
                    <v-list>
                      ...
                      <v-list-item>
                        ...
                        <v-list-item-content
                          v-if="food_product.first_day_num == -9999"
                          >未登録</v-list-item-content
                        >
                        <v-list-item-content v-else>{{
                          food_product.first_day_num
                      ...
                      <v-list-item>
                        ...
                        <v-list-item-content
                          v-if="food_product.second_day_num == -9999"
                          >未登録</v-list-item-content
                        >
                        <v-list-item-content v-else>{{
                          food_product.second_day_num
                      ...
                      <v-list-item>
                        ...
                        <v-list-item-content
                          v-if="food_product.is_cooking == -9999"
                          >未登録</v-list-item-content
                        >
                        <v-list-item-content
                          v-else-if="food_product.is_cooking == true"
                          >調理する</v-list-item-content
                        >
                        <v-list-item-content
                          v-else-if="food_product.is_cooking == false"
                  ...
                  <v-card v-else flat>
                      ...
                      <v-tooltip top>
                        <template v-slot:activator="{ on, attrs }">
                          <v-btn
                            ...
                            v-on="on"
                            @click="
                              openPurchaseListDisplay(
                                purchase_list.id,
                                purchase_list.item,
                                purchase_list.food_product_id,
                                purchase_list.shop_id,
                                purchase_list.fes_date_id,
                                purchase_list.is_fresh
                              )
                            "
                          >
                            <v-icon>mdi-pencil</v-icon>
                      ...
                      <v-tooltip top>
                        <template v-slot:activator="{ on, attrs }">
                          <v-btn
                            ...
                            v-on="on"
                            @click="
                              open_delete_dialog_purchase(purchase_list.id)
                            "
                            x-small
                            fab
                            ><v-icon class="ma-5">mdi-delete</v-icon>
                    ...
                    <v-list>
                      ...
                      <v-list-item>
                        ...
                        <v-list-item-content
                          v-if="purchase_list.food_product == -9999"
                          >未登録</v-list-item-content
                        >
                        <v-list-item-content v-else>{{
                      ...
                      <v-list-item>
                        ...
                        <v-list-item-content
                          v-if="purchase_list.is_fresh == -9999"
                          >未登録</v-list-item-content
                        >
                        <v-list-item-content
                          v-else-if="purchase_list.is_fresh === true"
                          >はい</v-list-item-content
                        >
                        <v-list-item-content
                          v-else-if="purchase_list.is_fresh === false"
                      ...
                      <v-list-item>
                        ...
                        <v-list-item-content
                          v-if="purchase_list.fes_date == -9999"
                          >未登録</v-list-item-content
                        >
                        <v-list-item-content v-else>{{
    ...
    <v-dialog v-model="delete_dialog" width="500">
      <v-card class="mx-auto">
        <v-card-title class="main font-weight-bold">
          ...
          <v-spacer></v-spacer>
          <v-btn x-small fab text class="my-n2" @click="delete_dialog = false">

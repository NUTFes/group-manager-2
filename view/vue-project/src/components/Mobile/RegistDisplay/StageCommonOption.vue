<template>
  <v-container>
      ...
      <v-col>
        <v-card flat>
          <v-card-title class="font-weight-bold subtitle-2">
            ...
            <b>ステージオプション申請情報</b>
            <v-spacer />
            <v-btn x-small text fab @click="openStageOptionDisplay">
          ...
          <v-list class="subtitle-2">
            <v-list-item>
              ...
              <v-list-item-content
                v-if="regist.stage_common_option.own_equipment == -9999"
                >未登録</v-list-item-content
              >
              <v-list-item-content
                v-else-if="regist.stage_common_option.own_equipment === true"
            ...
            <v-list-item>
              ...
              <v-list-item-content
                v-if="regist.stage_common_option.camera_permission == -9999"
                >未登録</v-list-item-content
              >
              <v-list-item-content
                v-else-if="
                  regist.stage_common_option.camera_permission === true
                "
            ...
            <v-list-item>
              ...
              >
              <v-list-item-content
                v-else-if="regist.stage_common_option.loud_sound === true"
            ...
            <v-list-item>
              ...
              <v-list-item-content
                v-if="regist.stage_common_option.stage_content == -9999"
                >未登録</v-list-item-content
              >
    ...
    <!--Editsnackbar-->
    <v-snackbar top text color="purple accent-2" v-model="StageOptionSnackbar">
      ステージオプション情報を更新しました
    </v-snackbar>
  </v-container>
</template>

      ...
      <v-row>
        <v-col>
          <v-tabs vertical color="btn">
            <v-tab :value="tab - 1" class="font-weight-bold justify-start">
              <v-icon class="pr-2">mdi-account-group</v-icon>団体情報
            </v-tab>

            <v-tab :value="tab - 2" class="font-weight-bold justify-start">
              <v-icon class="pr-2">mdi-account-multiple</v-icon>副代表情報
            </v-tab>

            <v-tab :value="tab - 3" class="font-weight-bold justify-start">
              <v-icon class="pr-2">mdi-map-marker</v-icon>会場申請情報
            </v-tab>

            <v-tab :value="tab - 4" class="font-weight-bold justify-start">
              <v-icon class="pr-2">mdi-power-plug</v-icon>電力申請情報
            </v-tab>

            <v-tab :value="tab - 5" class="font-weight-bold justify-start">
              <v-icon class="pr-2">mdi-table-chair</v-icon>物品申請情報
            </v-tab>

            <v-tab :value="tab - 6" class="font-weight-bold justify-start">
            ...
            <v-tab :value="tab - 9" class="font-weight-bold justify-start">
              <v-icon class="pr-2">mdi-baguette</v-icon>販売食品情報
            </v-tab>

            <v-tab :value="tab - 10" class="font-weight-bold justify-start">
